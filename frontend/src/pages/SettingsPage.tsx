...
function GeneralTab({
  ...
  const oauthOptions = [
    { label: 'Do not pre-select, choose on current page', value: '' },
    ...((configOptions?.oauth_provider_options || []).filter((o) => o.value !== '')),
  ]

  return (
    <div className="space-y-8">
      <SettingGroup title="Theme" desc="Select application theme.">
      ...
      <SettingGroup
        ...
        desc="These settings define the default behavior for the account list and registration page."
      >
        <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-card)] divide-y divide-[var(--border)]/50">
          <SettingRow label="Identity Type">
            <select
          ...
          <SettingRow label="Execution Channel">
            <select
      ...
      <SettingGroup
        title="Browser Reuse"
        desc="When using background browser automation, you usually need to reuse a logged-in browser session."
      >
        <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-card)] divide-y divide-[var(--border)]/50">
          <SettingRow label="Preferred Email">
            <input
              type="text"
...
function AboutTab() {
  ...
  return (
    <div className="space-y-8">
      <SettingGroup title="Version Information" desc="Current version and update check.">
        <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-card)] divide-y divide-[var(--border)]/50">
      ...
      <SettingGroup title="Project Information">
        <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-card)] divide-y divide-[var(--border)]/50">
