  ...
  return (
    <section>
      ...
      <p className="mt-1 text-sm text-[var(--text-muted)]">
        Customize supported execution channels, identity types, and third-party OAuth for each platform.
      </p>
          ...
          return (
            ...
            >
              ...
              <div className="space-y-3">
                <div>
                  <p className="mb-2 text-xs text-[var(--text-muted)]">Execution Channel</p>
                ...
                <div>
                  <p className="mb-2 text-xs text-[var(--text-muted)]">Identity Type</p>
                ...
                <div>
                  <p className="mb-2 text-xs text-[var(--text-muted)]">Third-party OAuth</p>
                  <div className="flex flex-wrap gap-4">
